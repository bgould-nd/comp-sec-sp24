...
def decode(keys, messageOrig):
    ...
    message = [messageOrig[i-1] for i in ip]
...
def f(input, l):
    ...
    print('\t', ''.join(sP)) # print to list of f function values
    output = xor(sP, l)
    return output

print('Generated Keys:')
for k in generateKeys(key): print('\t', ''.join(k))
binary = decode(generateKeys(key), ciphertext)
print('Plaintext:\n\t', int2bytes(arr2binInt(binary)))
